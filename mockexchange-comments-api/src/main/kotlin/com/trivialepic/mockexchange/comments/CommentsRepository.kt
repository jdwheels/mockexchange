...
//    @Query(
//        value = "select comment FROM MockComment comment " +
//                "where comment.postId = :postId"
//    )
//    fun x(@Param("postId") postId: Long, pageable: Pageable): Page<MockComment>
    ...
    fun y(@Param("postIds") postIds: Set<Long>): List<MockComment>
}
