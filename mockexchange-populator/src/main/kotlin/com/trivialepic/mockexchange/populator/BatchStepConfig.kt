...
class BatchStepConfig<T>(
    ...
    private fun itemMarshaller(clazz: Class<T>): XStreamMarshaller {
    ...
    private fun itemReader(resource: Resource, name: String, marshaller: XStreamMarshaller): ItemReader<T> {
